...
\For {each phrase {\tt p} in the user query}
...
\endnote{Although this implementation of \textit{apropos} by default returns 10
results for a query but in the following listings the output has been
